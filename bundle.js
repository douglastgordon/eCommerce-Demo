...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)("#products").on("click", function (e) {
	  return makePage(e);
	});
	(0, _jquery2.default)("#cart").on("click", function (e) {
	  return makePage(e);
	});
	...
	var makePage = function makePage(e) {
	  content.empty();
	
	  _jquery2.default.getJSON("./product.json", function (data) {
	...
	var makeProductPage = function makeProductPage() {
	  title.html("Products");
	  content.css("flex-direction", "row");
	};
	
	var makeCartPage = function makeCartPage() {
	  title.html("Cart");
	  var totalPrice = (0, _jquery2.default)("<p></p>");
	  totalPrice.append("total price:    $" + total.toFixed(2));
	  content.append(totalPrice);
	  content.css("flex-direction", "column");
	};
	
	var makeProduct = function makeProduct(product) {
	  var newProduct = (0, _jquery2.default)("<div></div>");
	  ...
	  var name = (0, _jquery2.default)("<p></p>");
	  name.addClass("name");
	  ...
	  var button = makeButton(product.index);
	...
	var makeButton = function makeButton(id) {
	  var button = (0, _jquery2.default)("<div></div>");
	  button.addClass("button");
	  button.attr("id", id);
	  var buttonText = (0, _jquery2.default)("<p></p>");
	...
	var addToTotal = function addToTotal(productId) {
	  var price = (0, _jquery2.default)("#" + productId).find("#price").html();
	  total += parseFloat(price.slice(1));
	};
	
	var makeItem = function makeItem(product, number, border) {
	  var cartItem = (0, _jquery2.default)("<div></div>");
	  cartItem.addClass("cartItem");
	  if (border) {
	    cartItem.css("border", "1px solid black");
	  }
	
	  var imageCount = (0, _jquery2.default)("<div></div>");
	  ...
	  var count = (0, _jquery2.default)("<p></p>");
	...
	(0, _jquery2.default)(document).ready(makePage);
